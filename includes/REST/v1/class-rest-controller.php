...
abstract class Controller {
	 ...
	 * @var string
	 */
	protected $namespace = 'approveme/v1';
	...
	public function __construct() {
		...
		if ( null === $this->object_type ) {
			$message = sprintf( __( 'object_type must be defined by the extending class: %s', 'approveme' ), get_called_class() );
	...
	public function get_context_param( $args = array() ) {
		$param_details = array(
			'description'       => __( 'Scope under which the request is made; determines fields present in response.', 'approveme' ),
			'type'              => 'string',
	 ...
	 * @access public
	 *
	 * @param \ApproveMe\Base_Object|mixed $object  Object for output to the response.
	...
	/**
	 * Registers a new field on an existing ApproveMe object type.
	 *
	 * @since 1.0
	 * @access public
	 *
